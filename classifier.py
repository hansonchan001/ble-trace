...
outside = pd.DataFrame(pd.read_excel('processed_outside/02151127.xlsx')).values.tolist()
...
history = classifier.fit(X_train, Y_train, validation_split = 0.2, batch_size = 1, epochs = 400, shuffle= True)
